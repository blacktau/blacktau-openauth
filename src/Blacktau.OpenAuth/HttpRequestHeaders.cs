namespace Blacktau.OpenAuth
{
    ...
    public class HttpRequestHeaders : IHttpRequestHeaders
    {
        ...
        {
            get { return this.headers.CacheControl; }
            set { this.headers.CacheControl = value; }
        }
        ...
        {
            get { return this.headers.ConnectionClose; }
            set { this.headers.ConnectionClose = value; }
        }
        ...
        {
            get { return this.headers.ExpectContinue; }
            set { this.headers.ExpectContinue = value; }
        }
        ...
        {
            get { return this.headers.IfModifiedSince; }
            set { this.headers.IfModifiedSince = value; }
        }
        ...
        {
            get { return this.headers.IfRange; }
            set { this.headers.IfRange = value; }
        }

        public DateTimeOffset? IfUnmodifiedSince
        {
            get { return this.headers.IfUnmodifiedSince; }
            set { this.headers.IfUnmodifiedSince = value; }
        }

        public int? MaxForwards
        {
            get { return this.headers.MaxForwards; }
            set { this.headers.MaxForwards = value; }
        }
        ...
        {
            get { return this.headers.ProxyAuthorization; }
            set { this.headers.ProxyAuthorization = value; }
        }

        public RangeHeaderValue Range
        {
            get { return this.headers.Range; }
            set { this.headers.Range = value; }
        }

        public Uri Referrer
        {
            get { return this.headers.Referrer; }
            set { this.headers.Referrer = value; }
        }
        ...
        {
            get { return this.headers.TransferEncodingChunked; }
            set { this.headers.TransferEncodingChunked = value; }
        }
